...
### Return "execute"  if :
**1. Task Completion (NEW):**
- The user's task has been completed successfully.
- Explicitly states the task is finished, successful, or complete
- VLM indicates no further action is needed ("任务已完成", "done", "finished")
- The goal has been achieved based on the observation
**2. Standard UI Actions:**
- The UI element mentioned by the agent clearly exists on the screen.
- The action matches the user task.
- The agent did NOT guess or substitute another button.
